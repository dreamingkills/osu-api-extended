...
export declare const _mode: string[];
export declare const _genre: string[];
export declare const _language: string[];
...
export interface _beatmap {
    ...
    search(obj: {
        ...
        checksum?: string;
        filename?: string;
    }): Promise<beatmaps_short_2_object>;
    scores: {
        all(beatmap: number, obj: {
            mode?: 'osu' | 'fruits' | 'mania' | 'taiko';
            mods?: string;
        }): Promise<{
            scores: beatmap_scores_all[];
        }>;
        user(beatmap: number, user: number, obj: {
            mode?: 'osu' | 'fruits' | 'mania' | 'taiko';
            mods?: Array<string>;
        }): Promise<beatmap_scores_user>;
...
export interface _user {
    ...
    activity(user: number, obj: {
        limit?: number;
        offset?: string;
    }): Promise<user_activity_object[]>;
    kudosu(user: number, obj: {
        limit?: number;
        offset?: string;
    }): Promise<user_kudosu_object[]>;
    beatmaps: {
        loved(user: number, obj: {
            limit?: number;
            offset?: string;
        }): Promise<beatmaps_object[]>;
        ranked(user: number, obj: {
            limit?: number;
            offset?: string;
        }): Promise<beatmaps_object[]>;
        pending(user: number, obj: {
            limit?: number;
            offset?: string;
        }): Promise<beatmaps_object[]>;
        graveyard(user: number, obj: {
            limit?: number;
            offset?: string;
        }): Promise<beatmaps_object[]>;
        favourite(user: number, obj: {
            limit?: number;
            offset?: string;
        }): Promise<beatmaps_object[]>;
        most_played(user: number, obj: {
            limit?: number;
            offset?: string;
        }): Promise<beatmaps_object[]>;
    };
